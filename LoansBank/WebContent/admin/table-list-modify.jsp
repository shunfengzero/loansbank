...
<meta name="apple-mobile-web-app-title"
	content="<s:property value="#session.loginuser"/>" />
...
<body data-type="widgets">
			...
			<div class="am-fr tpl-header-navbar">
				<ul>
					...
					<li class="am-text-sm tpl-header-navbar-welcome"><a
						href="javascript:;">欢迎你, <span><s:property
									value="#session.loginuser" /></span>
					</a></li>
						...
						<ul class="am-dropdown-content tpl-dropdown-content">
								...
								class="tpl-dropdown-menu-messages-item am-cf">
									...
									<div class="menu-messages-content">
										...
										<div class="am-text-truncate">
											...
											的诞生，依托于 GitHub 及其他技术社区上一些优秀的资源；
											<s:property value="#session.loginuser" />
											的成长，则离不开用户的支持。
										</div>
							...
							<li class="tpl-dropdown-menu-messages"><a
								...
								class="tpl-dropdown-menu-messages-item am-cf">
									...
									<div class="menu-messages-content">
										<div class="menu-messages-content-title">
											<i class="am-icon-circle-o am-text-warning"></i> <span><s:property
													value="#session.loginuser" /></span>
										</div>
											...
											<tbody id="tid">
												<tr>
													<td><input type="hidden"
														style="background: 0; border: 0px;" id="id" name="id"
														value=""></td>
												</tr>
													<tr>
													<td>用户名</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="name" name="name"
														value="${param.name }"></td>
												</tr>
												<tr>
													<td>密码</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="pwd" name="pwd"
														value=""></td>
												</tr>
	...
	<script>
		$(function() {
			$.ajax({
				type : "post",
				url : "/LoansBank/users/modify?name=${ param.name}",
				dataType : "json",
		...
		function updateClick(){
			$.ajax({
				type : "post",
				url : "/LoansBank/users/modifyAdmin",
				dataType : "json",
