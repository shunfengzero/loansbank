								...
								<div class="am-u-sm-12">
									<form id="addForm" action="#" onsubmit="return false;">
										...
										<tbody id="tid">
											<tr>
												<td>用户名</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="userName" value=""></td>
											</tr>
											<tr>
												<td>密码</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="passWord" value=""></td>
											</tr>
											<tr>
												<td>真实姓名</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="realName" value=""></td>
											</tr>
											<tr>
												<td>性别</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="gender" value=""></td>
											</tr>
											<tr>
												<td>邮箱</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="email" value=""></td>
											</tr>
											<tr>
												<td>电话</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="telePhone" value=""></td>
											</tr>
											<tr>
												<td>地址</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="address" value=""></td>
											</tr>
											<tr>
	 											<td>注册时间</td>
												<td><input type="text" style="background:0;border:1px golden solid;" name="registTime" value=""></td>
											</tr>
											<tr>
											 	<td></td>
												<td>
