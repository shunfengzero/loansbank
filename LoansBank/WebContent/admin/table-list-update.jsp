						...
						<div class="widget am-cf">
							...
							<div class="widget-body  am-fr">
								...
								<div class="am-u-sm-12">
									<form id="updateForm" action="#" onsubmit="return false;">
										<table width="100%"
										...
										<tbody id="tid">
											<tr>
												<td>用户名</td>
												<td><input type="hidden" name="id" value="${param.id }"><input type="text" style="background:0;border:0px;" name="userName" value="${param.userName }"></td>
											</tr>
											<tr>
												<td>密码</td>
												<td><input type="text" style="background:0;border:0px;" name="passWord" value="${param.passWord }"></td>
											</tr>
											<tr>
												<td>真实姓名</td>
												<td><input type="text" style="background:0;border:0px;" name="realName" value="${param.realName }"></td>
											</tr>
											<tr>
												<td>性别</td>
												<td><input type="text" style="background:0;border:0px;" name="gender" value="${param.gender }"></td>
											</tr>
											<tr>
												<td>邮箱</td>
												<td><input type="text"  style="background:0;border:0px;" name="email" value="${param.email }"></td>
											</tr>
											<tr>
												<td>电话</td>
												<td><input type="text" style="background:0;border:0px;" name="telePhone" value="${param.telePhone }"></td>
											</tr>
											<tr>
												<td>地址</td>
												<td><input type="text"  style="background:0;border:0px;" name="address" value="${param.address }"></td>
											</tr>
											<tr>
	 											<td>注册时间</td>
												<td><input type="hidden"name="page" value="${param.page }"><input type="text" style="background:0;border:0px;" name="registTime" value="${param.registTime }"></td>
											</tr>
											...
											<tr>
												...
												<td>
													<button type="button" onclick="updateClick()"
														class="am-btn am-btn-default am-btn-success">
														<span class="am-icon-plus"></span> 修改
													</button>
