    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            ...
            <div class="tpl-login-content">
                ...
                <form id="f1" class="am-form tpl-form-line-form" action="#" onsubmit="return false;">
                    ...
                    <div class="am-form-group">
                        ...
                        <button type="button" onclick="submitClick()" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">提交</button>
