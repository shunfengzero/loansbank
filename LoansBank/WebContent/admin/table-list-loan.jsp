...
<body data-type="widgets">
					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title  am-cf">贷款人列表</div>
	...
	<script>
		$(function() {
			...
			$.ajax({
				type : "post",
				url : "/LoansBank/findUsersApply?cp=1&id=1",
				dataType : "json",
		...
		function findUsers(cp,id) {
			$.ajax({
				type : "post",
				url : "/LoansBank/findUsersApply?cp=" + cp+"&id" +id,
				dataType : "json",
				success : function(data) {
					if (data.code == 1) {
						bindData(data.msg, data.page, data.currentPage);
		...
		function editorUser(id) {
			$.ajax({
				type : "post",
				url : "/LoansBank/editorUserApply?id=" + id,
				dataType : "json",
				success : function(data) {
					if (data.code == 1) {
		...
		function deleteUser(id,cp) {
			$.ajax({
				type : "post",
				url : "/LoansBank/deleteUserApply?id=" + id + "&cp="+cp,
				dataType : "json",
				success : function(data) {
					if (data.code == 1) {
						bindData(data.msg, data.page, data.currentPage);
						window.location.href="/LoansBank/admin/table-list-loan.jsp";
					} else {
						alert(data.msg);
					}
				}
		...
		function serach() {
			...
			$.ajax({
				type : "post",
				url : "/LoansBank/findApplyUsersApply",
			...
			$(info)
					.each(
							function() {
								...
								html += "<td>" + this.limitMoney + "</td>";
								html += "<td>" + this.limitTime + "</td>";
