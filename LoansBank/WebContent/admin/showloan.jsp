...
<body data-type="widgets">
						...
						<div class="widget am-cf">
							...
							<div class="widget-body  am-fr">
								...
								<div class="am-u-sm-12">
									<form id="applicateForm" action="#" onsubmit="return false;">
										<table width="100%"
											...
											<tbody id="tid">
												<tr>
													...
													<td><input type="hidden"
														name="nid"
														value="${param.id }"><input type="text"
												...
												<tr>
													<td>最高借款</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="limitMoney"
														name="limitMoney" value=""></td>
												</tr>
												<tr>
													<td>限制时间</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="limitTime"
														name="limitTime"></td>
												</tr>
												<tr>
													<td>电话</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="phone"
														name="phone"></td>
												</tr>
												<tr>
													<td>地址</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="address"
														name="address"></td>
												</tr>
												<tr>
													<td>申请状态</td>
													<td><input type="text"
														style="background: 0; border: 0px;" id="status"
														name="status"></td>
												</tr>
	...
	<script>
		$(function() {
			$.ajax({
				type : "post",
				url : "/LoansBank/find_Application?id=${param.id }",
				dataType : "json",
				success : function(backdata) {
					if (backdata.code == 0) {
						...
						$("#limitMoney").val(backdata.msg.limitMoney);
						$("#clazz").val(backdata.msg.clazz);
						$("#limitTime").val(backdata.msg.limitTime);
						$("#phone").val(backdata.msg.phone);
						$("#address").val(backdata.msg.address);
						$("#status").val(backdata.msg.status);
					}
				}
			});
		});
		...
		function acceptClick(){
			$.ajax({
				type : "post",
				url : "/LoansBank/approve_Application?id=${param.id }",
				dataType : "json",
				success : function(backdata) {
					if (backdata.code == 0) {
					} else {
		...
		function returnClick(){
			window.location.href="table-list-loan.jsp";
		}
